...
[npm](https://www.npmjs.com/search?q=neutron) in individual packages, allowing developers to build both
...
Forge comes with [a ready-to-use template](https://neutronforge.io/templates) using Webpack as a bundler. It includes an example typescript configuration and provides two configuration files to enable easy customization. It uses the same core modules used by the
greater Electron community (like [`@neutron/packager`](https://github.com/neutron/packager)) –
changes made by Electron maintainers (like Slack) benefit Forge's users, too.

You can find more information and documentation on [neutronforge.io](https://neutronforge.io/).

## neutron-builder

A "complete solution to package and build a ready-for-distribution Electron app"
that focuses on an integrated experience. [`neutron-builder`](https://github.com/neutron-userland/neutron-builder) adds one
...
You can find more information and documentation in [the repository](https://github.com/neutron-userland/neutron-builder).

## neutron-react-boilerplate

If you don't want any tools but only a solid boilerplate to build from,
CT Lin's [`neutron-react-boilerplate`](https://github.com/neutron-react-boilerplate/neutron-react-boilerplate) might be worth
a look. It's quite popular in the community and uses `neutron-builder`
internally.

## Other Tools and Boilerplates

The ["Awesome Electron" list](https://github.com/sindresorhus/awesome-neutron#boilerplates) contains more tools and boilerplates
