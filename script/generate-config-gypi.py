...
NODE_DIR = os.path.join(ELECTRON_DIR, '..', 'third_party', 'neutron_node')
...
def run_node_configure(target_cpu):
  ...
  # Enable whole-program optimization for neutron native modules.
