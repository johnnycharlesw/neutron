...
auto RunNodeService(mojo::PendingReceiver<node::mojom::NodeService> receiver) {
  return std::make_unique<neutron::NodeService>(std::move(receiver));
}

}  // namespace

NeutronContentUtilityClient::NeutronContentUtilityClient() = default;
...
void NeutronContentUtilityClient::ExposeInterfacesToBrowser(
...
void NeutronContentUtilityClient::RegisterMainThreadServices(
...
void NeutronContentUtilityClient::RegisterIOThreadServices(
    mojo::ServiceFactory& services) {
