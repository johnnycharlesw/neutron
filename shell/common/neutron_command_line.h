...
class NeutronCommandLine {
 public:
  // disable copy
  NeutronCommandLine() = delete;
  NeutronCommandLine(const NeutronCommandLine&) = delete;
  NeutronCommandLine& operator=(const NeutronCommandLine&) = delete;
