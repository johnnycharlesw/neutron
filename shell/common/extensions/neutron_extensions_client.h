...
class NeutronExtensionsClient : public extensions::ExtensionsClient {
 public:
  using ScriptingAllowlist = extensions::ExtensionsClient::ScriptingAllowlist;

  NeutronExtensionsClient();
  ~NeutronExtensionsClient() override;

  // disable copy
  NeutronExtensionsClient(const NeutronExtensionsClient&) = delete;
  NeutronExtensionsClient& operator=(const NeutronExtensionsClient&) = delete;
