...
#include "shell/common/api/neutron_api_url_loader.h"
...
v8::Local<v8::Promise> ResolveHost(
  ...
  auto fn = base::MakeRefCounted<neutron::ResolveHostFunction>(
...
using neutron::api::SimpleURLLoaderWrapper;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_common_net, Initialize)
