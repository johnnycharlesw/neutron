...
v8::Local<v8::Value> Clipboard::ReadBuffer(v8::Isolate* const isolate,
  ...
  return neutron::Buffer::Copy(isolate, data).ToLocalChecked();
}
...
void Initialize(v8::Local<v8::Object> exports,
  ...
  dict.SetMethod("availableFormats",
                 &neutron::api::Clipboard::AvailableFormats);
  dict.SetMethod("has", &neutron::api::Clipboard::Has);
  dict.SetMethod("read", &neutron::api::Clipboard::Read);
  dict.SetMethod("write", &neutron::api::Clipboard::Write);
  dict.SetMethod("readText", &neutron::api::Clipboard::ReadText);
  dict.SetMethod("writeText", &neutron::api::Clipboard::WriteText);
  dict.SetMethod("readRTF", &neutron::api::Clipboard::ReadRTF);
  dict.SetMethod("writeRTF", &neutron::api::Clipboard::WriteRTF);
  dict.SetMethod("readHTML", &neutron::api::Clipboard::ReadHTML);
  dict.SetMethod("writeHTML", &neutron::api::Clipboard::WriteHTML);
  dict.SetMethod("readBookmark", &neutron::api::Clipboard::ReadBookmark);
  dict.SetMethod("writeBookmark", &neutron::api::Clipboard::WriteBookmark);
  dict.SetMethod("readImage", &neutron::api::Clipboard::ReadImage);
  dict.SetMethod("writeImage", &neutron::api::Clipboard::WriteImage);
  dict.SetMethod("readFindText", &neutron::api::Clipboard::ReadFindText);
  dict.SetMethod("writeFindText", &neutron::api::Clipboard::WriteFindText);
  dict.SetMethod("readBuffer", &neutron::api::Clipboard::ReadBuffer);
  dict.SetMethod("writeBuffer", &neutron::api::Clipboard::WriteBuffer);
  dict.SetMethod("_writeFilesForTesting",
                 &neutron::api::Clipboard::WriteFilesForTesting);
  dict.SetMethod("clear", &neutron::api::Clipboard::Clear);
}

}  // namespace

NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_common_clipboard, Initialize)
