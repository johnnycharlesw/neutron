...
#include "shell/common/api/neutron_api_shared_texture.h"
...
namespace neutron::api::shared_texture {
...
void Initialize(v8::Local<v8::Object> exports,
  ...
  dict.SetMethod("importSharedTexture",
                 &neutron::api::shared_texture::ImportSharedTexture);
  dict.SetMethod("finishTransferSharedTexture",
                 &neutron::api::shared_texture::FinishTransferSharedTexture);
}

}  // namespace

NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_common_shared_texture, Initialize)
