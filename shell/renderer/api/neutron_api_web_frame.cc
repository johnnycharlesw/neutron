...
#include "shell/renderer/api/neutron_api_spell_check_client.h"
 ...
 private:
  ...
  v8::Local<v8::Value> GetWebPreference(v8::Isolate* isolate,
    ...
    if (pref_name == "isWebView") {
      ...
      // Please check NeutronRenderFrameObserver::DidInstallConditionalFeatures
      // for the background.
...
void Initialize(v8::Local<v8::Object> exports,
                ...
                v8::Local<v8::Context> context,
                void* priv) {
  using namespace neutron::api;  // NOLINT(build/namespaces)
  ...
  dict.Set("mainFrame",
           WebFrameRenderer::Create(
               isolate, neutron::GetRenderFrame(isolate, exports)));
}

}  // namespace

NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_renderer_web_frame, Initialize)
