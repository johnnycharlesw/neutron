...
#include "third_party/neutron_node/src/node_binding.h"
...
NeutronSandboxedRendererClient::NeutronSandboxedRendererClient() {
  // Explicitly register neutron's builtin bindings.
  NodeBindings::RegisterBuiltinBindings();
  metrics_ = base::ProcessMetrics::CreateCurrentProcessMetrics();
}

NeutronSandboxedRendererClient::~NeutronSandboxedRendererClient() = default;

void NeutronSandboxedRendererClient::InitializeBindings(
...
void NeutronSandboxedRendererClient::DidCreateScriptContext(
  ...
  util::CompileAndCall(
      isolate, isolate->GetCurrentContext(), "neutron/js2c/sandbox_bundle",
...
void NeutronSandboxedRendererClient::WillReleaseScriptContext(
    v8::Isolate* const isolate,
    v8::Local<v8::Context> context,
    content::RenderFrame* render_frame) {
...
void NeutronSandboxedRendererClient::EmitProcessEvent(
    content::RenderFrame* render_frame,
...
void NeutronSandboxedRendererClient::WillEvaluateServiceWorkerOnWorkerThread(
...
void NeutronSandboxedRendererClient::
