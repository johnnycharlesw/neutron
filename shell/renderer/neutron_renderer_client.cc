...
NeutronRendererClient::NeutronRendererClient()
...
NeutronRendererClient::~NeutronRendererClient() = default;

void NeutronRendererClient::PostIOThreadCreated(
...
void NeutronRendererClient::RenderFrameCreated(
    content::RenderFrame* render_frame) {
  new NeutronRenderFrameObserver(render_frame, this);
  RendererClientBase::RenderFrameCreated(render_frame);
}

void NeutronRendererClient::RunScriptsAtDocumentStart(
    content::RenderFrame* render_frame) {
...
void NeutronRendererClient::RunScriptsAtDocumentEnd(
    content::RenderFrame* render_frame) {
...
void NeutronRendererClient::UndeferLoad(content::RenderFrame* render_frame) {
  render_frame->GetWebFrame()->GetDocumentLoader()->SetDefersLoading(
      blink::LoaderFreezeMode::kNone);
}

void NeutronRendererClient::DidCreateScriptContext(
  ...
  std::shared_ptr<node::Environment> env = node_bindings_->CreateEnvironment(
      ...
      base::BindRepeating(&NeutronRendererClient::UndeferLoad,
...
void NeutronRendererClient::WillReleaseScriptContext(
    v8::Isolate* const isolate,
...
void NeutronRendererClient::WorkerScriptReadyForEvaluationOnWorkerThread(
    v8::Local<v8::Context> context) {
...
void NeutronRendererClient::WillDestroyWorkerContextOnWorkerThread(
    v8::Local<v8::Context> context) {
  auto* ec = blink::ExecutionContext::From(context);
  if (ec->IsServiceWorkerGlobalScope() || ec->IsSharedWorkerGlobalScope() ||
      ec->IsMainThreadWorkletGlobalScope())
...
void NeutronRendererClient::SetUpWebAssemblyTrapHandler() {
...
node::Environment* NeutronRendererClient::GetEnvironment(
