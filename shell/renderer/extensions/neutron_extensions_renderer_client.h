...
class NeutronExtensionsRendererClient
 ...
 public:
  NeutronExtensionsRendererClient();
  ~NeutronExtensionsRendererClient() override;

  // disable copy
  NeutronExtensionsRendererClient(const NeutronExtensionsRendererClient&) =
      delete;
  NeutronExtensionsRendererClient& operator=(
      const NeutronExtensionsRendererClient&) = delete;
