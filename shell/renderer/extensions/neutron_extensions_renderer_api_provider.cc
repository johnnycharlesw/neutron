...
void NeutronExtensionsRendererAPIProvider::RegisterNativeHandlers(
...
void NeutronExtensionsRendererAPIProvider::AddBindingsSystemHooks(
...
void NeutronExtensionsRendererAPIProvider::PopulateSourceMap(
    extensions::ResourceBundleSourceMap* source_map) const {}

void NeutronExtensionsRendererAPIProvider::EnableCustomElementAllowlist()
    const {}

void NeutronExtensionsRendererAPIProvider::RequireWebViewModules(
    extensions::ScriptContext* context) const {}
