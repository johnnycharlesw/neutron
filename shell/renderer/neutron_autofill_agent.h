...
class AutofillAgent : private content::RenderFrameObserver,
                      ...
                      private mojom::NeutronAutofillAgent {
 public:
  ...
  void BindPendingReceiver(
      mojo::PendingAssociatedReceiver<mojom::NeutronAutofillAgent>
          pending_receiver);
 ...
 private:
  ...
  const mojo::AssociatedRemote<mojom::NeutronAutofillDriver>&
  GetAutofillDriver();
  mojo::AssociatedRemote<mojom::NeutronAutofillDriver> autofill_driver_;
  ...
  mojo::AssociatedReceiver<mojom::NeutronAutofillAgent> receiver_{this};
