...
class NeutronSandboxedRendererClient : public RendererClientBase {
 public:
  NeutronSandboxedRendererClient();
  ~NeutronSandboxedRendererClient() override;

  // disable copy
  NeutronSandboxedRendererClient(const NeutronSandboxedRendererClient&) =
      delete;
  NeutronSandboxedRendererClient& operator=(
      const NeutronSandboxedRendererClient&) = delete;

  void InitializeBindings(v8::Local<v8::Object> binding,
                          v8::Isolate* isolate,
                          v8::Local<v8::Context> context,
                          content::RenderFrame* render_frame);
  // neutron::RendererClientBase:
