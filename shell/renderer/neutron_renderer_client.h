...
class NeutronRendererClient : public RendererClientBase {
 public:
  NeutronRendererClient();
  ~NeutronRendererClient() override;

  // disable copy
  NeutronRendererClient(const NeutronRendererClient&) = delete;
  NeutronRendererClient& operator=(const NeutronRendererClient&) = delete;
