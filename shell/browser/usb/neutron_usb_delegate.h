...
class NeutronUsbDelegate : public content::UsbDelegate {
 public:
  NeutronUsbDelegate();
  NeutronUsbDelegate(NeutronUsbDelegate&&) = delete;
  NeutronUsbDelegate& operator=(NeutronUsbDelegate&) = delete;
  ~NeutronUsbDelegate() override;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronUsbDelegate> weak_factory_{this};
};
