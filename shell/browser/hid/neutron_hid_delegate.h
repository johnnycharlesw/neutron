...
class NeutronHidDelegate : public content::HidDelegate {
 public:
  NeutronHidDelegate();
  NeutronHidDelegate(NeutronHidDelegate&) = delete;
  NeutronHidDelegate& operator=(NeutronHidDelegate&) = delete;
  ~NeutronHidDelegate() override;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronHidDelegate> weak_factory_{this};
};
