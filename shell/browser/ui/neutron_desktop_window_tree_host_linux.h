...
class NeutronDesktopWindowTreeHostLinux
    : public views::DesktopWindowTreeHostLinux,
      private ui::NativeThemeObserver,
      private ui::DeviceScaleFactorObserver {
 public:
  NeutronDesktopWindowTreeHostLinux(
      NativeWindowViews* native_window_view,
      views::Widget* widget,
      views::DesktopNativeWidgetAura* desktop_native_widget_aura);
  ~NeutronDesktopWindowTreeHostLinux() override;

  // disable copy
  NeutronDesktopWindowTreeHostLinux(
      const NeutronDesktopWindowTreeHostLinux&) = delete;
  NeutronDesktopWindowTreeHostLinux& operator=(
      const NeutronDesktopWindowTreeHostLinux&) = delete;
