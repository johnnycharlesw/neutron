...
NeutronDesktopWindowTreeHostLinux::NeutronDesktopWindowTreeHostLinux(
...
bool NeutronDesktopWindowTreeHostLinux::SupportsClientFrameShadow() const {
  return platform_window()->CanSetDecorationInsets() &&
         views::Widget::IsWindowCompositingSupported();
}

void NeutronDesktopWindowTreeHostLinux::OnWidgetInitDone() {
  views::DesktopWindowTreeHostLinux::OnWidgetInitDone();
  UpdateFrameHints();
}

bool NeutronDesktopWindowTreeHostLinux::IsShowingFrame() const {
  return !native_window_view_->IsFullscreen() &&
         !native_window_view_->IsMaximized() &&
         !native_window_view_->IsMinimized();
}

gfx::Insets NeutronDesktopWindowTreeHostLinux::CalculateInsetsInDIP(
...
void NeutronDesktopWindowTreeHostLinux::OnBoundsChanged(
...
void NeutronDesktopWindowTreeHostLinux::OnWindowStateChanged(
...
void NeutronDesktopWindowTreeHostLinux::OnWindowTiledStateChanged(
...
void NeutronDesktopWindowTreeHostLinux::UpdateWindowState(
    ui::PlatformWindowState new_state) {
...
void NeutronDesktopWindowTreeHostLinux::OnNativeThemeUpdated(
    ui::NativeTheme* observed_theme) {
  UpdateFrameHints();
}

void NeutronDesktopWindowTreeHostLinux::OnDeviceScaleFactorChanged() {
  UpdateFrameHints();
}

void NeutronDesktopWindowTreeHostLinux::UpdateFrameHints() {
...
void NeutronDesktopWindowTreeHostLinux::DispatchEvent(ui::Event* event) {
...
void NeutronDesktopWindowTreeHostLinux::AddAdditionalInitProperties(
