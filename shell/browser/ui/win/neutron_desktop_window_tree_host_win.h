...
class NeutronDesktopWindowTreeHostWin : public views::DesktopWindowTreeHostWin,
                                         public ::ui::NativeThemeObserver {
 public:
  NeutronDesktopWindowTreeHostWin(
      NativeWindowViews* native_window_view,
      views::Widget* widget,
      views::DesktopNativeWidgetAura* desktop_native_widget_aura);
  ~NeutronDesktopWindowTreeHostWin() override;

  // disable copy
  NeutronDesktopWindowTreeHostWin(const NeutronDesktopWindowTreeHostWin&) =
      delete;
  NeutronDesktopWindowTreeHostWin& operator=(
      const NeutronDesktopWindowTreeHostWin&) = delete;
