...
NeutronDesktopNativeWidgetAura::NeutronDesktopNativeWidgetAura(
    NativeWindowViews* native_window_view,
    views::Widget* widget)
    : views::DesktopNativeWidgetAura{widget},
      native_window_view_{native_window_view},
      desktop_window_tree_host_{new NeutronDesktopWindowTreeHostWin{
          native_window_view, widget, this}} {
  GetNativeWindow()->SetName("NeutronDesktopNativeWidgetAura");
  // This is to enable the override of OnWindowActivated
  wm::SetActivationChangeObserver(GetNativeWindow(), this);
}

void NeutronDesktopNativeWidgetAura::InitNativeWidget(
...
#if BUILDFLAG(IS_WIN)
void NeutronDesktopNativeWidgetAura::OnSizeConstraintsChanged() {
...
void NeutronDesktopNativeWidgetAura::Activate() {
...
void NeutronDesktopNativeWidgetAura::OnWindowActivated(
