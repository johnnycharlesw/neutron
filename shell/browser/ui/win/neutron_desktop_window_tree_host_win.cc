...
NeutronDesktopWindowTreeHostWin::NeutronDesktopWindowTreeHostWin(
...
NeutronDesktopWindowTreeHostWin::~NeutronDesktopWindowTreeHostWin() = default;

bool NeutronDesktopWindowTreeHostWin::ShouldUpdateWindowTransparency() const {
...
void NeutronDesktopWindowTreeHostWin::OnWidgetInitDone() {
  widget_init_done_ = true;
}

bool NeutronDesktopWindowTreeHostWin::PreHandleMSG(UINT message,
                                                    WPARAM w_param,
                                                    LPARAM l_param,
                                                    LRESULT* result) {
...
bool NeutronDesktopWindowTreeHostWin::ShouldPaintAsActive() const {
...
bool NeutronDesktopWindowTreeHostWin::GetDwmFrameInsetsInPixels(
...
bool NeutronDesktopWindowTreeHostWin::GetClientAreaInsets(
    gfx::Insets* insets,
...
bool NeutronDesktopWindowTreeHostWin::HandleMouseEventForCaption(
    UINT message) const {
...
bool NeutronDesktopWindowTreeHostWin::HandleMouseEvent(ui::MouseEvent* event) {
...
void NeutronDesktopWindowTreeHostWin::HandleVisibilityChanged(bool visible) {
...
void NeutronDesktopWindowTreeHostWin::SetAllowScreenshots(bool allow) {
...
void NeutronDesktopWindowTreeHostWin::UpdateAllowScreenshots() {
...
void NeutronDesktopWindowTreeHostWin::OnNativeThemeUpdated(
...
bool NeutronDesktopWindowTreeHostWin::ShouldWindowContentsBeTransparent()
    const {
  ...
  // https://github.com/neutron/neutron/pull/39895
