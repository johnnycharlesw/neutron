...
@interface NeutronMenuController
    : NSObject <NSMenuDelegate, NSSharingServiceDelegate> {
 @protected
  base::WeakPtr<neutron::NeutronMenuModel> model_;
...
- (id)initWithModel:(neutron::NeutronMenuModel*)model
    useDefaultAccelerator:(BOOL)use;

- (void)setPopupCloseCallback:(base::OnceClosure)callback;

// Populate current NSMenu with |model|.
- (void)populateWithModel:(neutron::NeutronMenuModel*)model;

// Programmatically close the constructed menu.
- (void)cancel;

- (neutron::NeutronMenuModel*)model;
- (void)setModel:(neutron::NeutronMenuModel*)model;
...
- (NSMenuItem*)makeMenuItemForIndex:(NSInteger)index
                          fromModel:(neutron::NeutronMenuModel*)model;
