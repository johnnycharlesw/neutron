...
class NeutronNativeWidgetMac : public views::NativeWidgetMac {
 public:
  NeutronNativeWidgetMac(NativeWindowMac* shell,
                          const std::string& window_type,
                          NSUInteger style_mask,
                          views::internal::NativeWidgetDelegate* delegate);
  ~NeutronNativeWidgetMac() override;

  // disable copy
  NeutronNativeWidgetMac(const NeutronNativeWidgetMac&) = delete;
  NeutronNativeWidgetMac& operator=(const NeutronNativeWidgetMac&) = delete;
