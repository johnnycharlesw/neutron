...
class NeutronMenuModel : public ui::SimpleMenuModel {
 public:
#if BUILDFLAG(IS_MAC)
  struct SharingItem {
    SharingItem();
  ...
  explicit NeutronMenuModel(Delegate* delegate);
  ~NeutronMenuModel() override;

  // disable copy
  NeutronMenuModel(const NeutronMenuModel&) = delete;
  NeutronMenuModel& operator=(const NeutronMenuModel&) = delete;
  ...
  base::WeakPtr<NeutronMenuModel> GetWeakPtr() {
    return weak_factory_.GetWeakPtr();
  }

  using SimpleMenuModel::GetSubmenuModelAt;
  NeutronMenuModel* GetSubmenuModelAt(size_t index);
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronMenuModel> weak_factory_{this};
};
