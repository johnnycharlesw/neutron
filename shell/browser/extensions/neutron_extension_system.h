...
class NeutronExtensionSystem : public ExtensionSystem {
 public:
  using InstallUpdateCallback = ExtensionSystem::InstallUpdateCallback;
  explicit NeutronExtensionSystem(content::BrowserContext* browser_context);
  ~NeutronExtensionSystem() override;

  // disable copy
  NeutronExtensionSystem(const NeutronExtensionSystem&) = delete;
  NeutronExtensionSystem& operator=(const NeutronExtensionSystem&) = delete;
 ...
 private:
  ...
  std::unique_ptr<NeutronExtensionLoader> extension_loader_;
  ...
  base::WeakPtrFactory<NeutronExtensionSystem> weak_factory_{this};
};
