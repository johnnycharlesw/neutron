...
// Delegate in Neutron that provides an extension/app API with Kiosk mode
// functionality.
class NeutronKioskDelegate : public extensions::KioskDelegate {
 public:
  NeutronKioskDelegate();
  ~NeutronKioskDelegate() override;
