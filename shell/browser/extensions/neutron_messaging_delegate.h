...
class NeutronMessagingDelegate : public MessagingDelegate {
 public:
  NeutronMessagingDelegate();
  ~NeutronMessagingDelegate() override;

  // disable copy
  NeutronMessagingDelegate(const NeutronMessagingDelegate&) = delete;
  NeutronMessagingDelegate& operator=(const NeutronMessagingDelegate&) =
      delete;
