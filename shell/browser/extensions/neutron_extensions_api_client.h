...
class NeutronMessagingDelegate;

class NeutronExtensionsAPIClient : public ExtensionsAPIClient {
 public:
  NeutronExtensionsAPIClient();
  ~NeutronExtensionsAPIClient() override;
 ...
 private:
  std::unique_ptr<NeutronMessagingDelegate> messaging_delegate_;
};
