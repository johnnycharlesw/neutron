...
class NeutronExtensionWebContentsObserver
    : public ExtensionWebContentsObserver,
      public content::WebContentsUserData<
          NeutronExtensionWebContentsObserver> {
 public:
  ~NeutronExtensionWebContentsObserver() override;

  // disable copy
  NeutronExtensionWebContentsObserver(
      const NeutronExtensionWebContentsObserver&) = delete;
  NeutronExtensionWebContentsObserver& operator=(
      const NeutronExtensionWebContentsObserver&) = delete;
 ...
 private:
  ...
  explicit NeutronExtensionWebContentsObserver(
