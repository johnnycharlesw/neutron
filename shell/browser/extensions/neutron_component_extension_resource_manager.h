...
class NeutronComponentExtensionResourceManager
 ...
 public:
  ...
  ~NeutronComponentExtensionResourceManager() override;

  // disable copy
  NeutronComponentExtensionResourceManager(
      const NeutronComponentExtensionResourceManager&) = delete;
  NeutronComponentExtensionResourceManager& operator=(
      const NeutronComponentExtensionResourceManager&) = delete;
