...
class NeutronExtensionLoader : public ExtensionRegistrar::Delegate {
 public:
  explicit NeutronExtensionLoader(content::BrowserContext* browser_context);
  ~NeutronExtensionLoader() override;

  // disable copy
  NeutronExtensionLoader(const NeutronExtensionLoader&) = delete;
  NeutronExtensionLoader& operator=(const NeutronExtensionLoader&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronExtensionLoader> weak_factory_{this};
};
