...
class NeutronProcessManagerDelegate;
class ProcessMap;
class SafeBrowsingDelegate;
class NeutronComponentExtensionResourceManager;
}  // namespace extensions
...
class NeutronExtensionsBrowserClient
 ...
 public:
  ...
  ~NeutronExtensionsBrowserClient() override;

  // disable copy
  NeutronExtensionsBrowserClient(const NeutronExtensionsBrowserClient&) =
      delete;
  NeutronExtensionsBrowserClient& operator=(
      const NeutronExtensionsBrowserClient&) = delete;
 ...
 private:
  ...
  std::unique_ptr<extensions::NeutronProcessManagerDelegate>
  ...
  std::unique_ptr<extensions::NeutronComponentExtensionResourceManager>
      resource_manager_;
};
