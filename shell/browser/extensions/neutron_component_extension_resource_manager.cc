...
NeutronComponentExtensionResourceManager::
    NeutronComponentExtensionResourceManager() {
...
NeutronComponentExtensionResourceManager::
    ~NeutronComponentExtensionResourceManager() = default;

bool NeutronComponentExtensionResourceManager::IsComponentExtensionResource(
...
NeutronComponentExtensionResourceManager::GetTemplateReplacementsForExtension(
...
void NeutronComponentExtensionResourceManager::AddComponentResourceEntries(
