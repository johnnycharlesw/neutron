...
NeutronExtensionHostDelegate::NeutronExtensionHostDelegate() = default;

NeutronExtensionHostDelegate::~NeutronExtensionHostDelegate() = default;

void NeutronExtensionHostDelegate::OnExtensionHostCreated(
    content::WebContents* web_contents) {
  NeutronExtensionWebContentsObserver::CreateForWebContents(web_contents);
  v8::Isolate* isolate = v8::Isolate::GetCurrent();
  v8::HandleScope scope(isolate);
  neutron::api::WebContents::FromOrCreate(isolate, web_contents);
}

void NeutronExtensionHostDelegate::CreateTab(
...
void NeutronExtensionHostDelegate::ProcessMediaAccessRequest(
    content::WebContents* web_contents,
...
bool NeutronExtensionHostDelegate::CheckMediaAccessPermission(
...
NeutronExtensionHostDelegate::EnterPictureInPicture(
    content::WebContents* web_contents) {
  NOTREACHED();
}

void NeutronExtensionHostDelegate::ExitPictureInPicture() {
  NOTREACHED();
}
