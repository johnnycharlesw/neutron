...
#include "neutron/shell/common/extensions/api/tabs.h"
...
NeutronMessagingDelegate::NeutronMessagingDelegate() = default;
NeutronMessagingDelegate::~NeutronMessagingDelegate() = default;

MessagingDelegate::PolicyPermission
NeutronMessagingDelegate::IsNativeMessagingHostAllowed(
...
std::optional<base::Value::Dict> NeutronMessagingDelegate::MaybeGetTabInfo(
...
content::WebContents* NeutronMessagingDelegate::GetWebContentsByTabId(
    content::BrowserContext* browser_context,
    int tab_id) {
...
NeutronMessagingDelegate::CreateReceiverForNativeApp(
    content::BrowserContext* browser_context,
...
void NeutronMessagingDelegate::QueryIncognitoConnectability(
