...
NeutronNavigationUIData::NeutronNavigationUIData() = default;

NeutronNavigationUIData::NeutronNavigationUIData(
...
std::unique_ptr<content::NavigationUIData> NeutronNavigationUIData::Clone() {
  std::unique_ptr<NeutronNavigationUIData> copy =
      std::make_unique<NeutronNavigationUIData>();
...
void NeutronNavigationUIData::SetExtensionNavigationUIData(
