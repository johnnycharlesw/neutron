...
// on the IO thread.
class NeutronNavigationUIData : public content::NavigationUIData {
 public:
  NeutronNavigationUIData();
  explicit NeutronNavigationUIData(
      content::NavigationHandle* navigation_handle);
  ~NeutronNavigationUIData() override;

  // disable copy
  NeutronNavigationUIData(const NeutronNavigationUIData&) = delete;
  NeutronNavigationUIData& operator=(const NeutronNavigationUIData&) = delete;
