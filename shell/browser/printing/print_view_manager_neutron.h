...
class PrintViewManagerNeutron
    : public printing::PrintViewManagerBase,
      public content::WebContentsUserData<PrintViewManagerNeutron> {
 public:
  ~PrintViewManagerNeutron() override;

  PrintViewManagerNeutron(const PrintViewManagerNeutron&) = delete;
  PrintViewManagerNeutron& operator=(const PrintViewManagerNeutron&) = delete;
 ...
 private:
  friend class content::WebContentsUserData<PrintViewManagerNeutron>;

  explicit PrintViewManagerNeutron(content::WebContents* web_contents);
  ...
  base::WeakPtrFactory<PrintViewManagerNeutron> weak_factory_{this};
