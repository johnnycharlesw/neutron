...
class NeutronNSSCryptoModuleDelegate
    : public crypto::CryptoModuleBlockingPasswordDelegate {
 public:
  explicit NeutronNSSCryptoModuleDelegate(const net::HostPortPair& server);
  NeutronNSSCryptoModuleDelegate(const NeutronNSSCryptoModuleDelegate&) =
      delete;
  NeutronNSSCryptoModuleDelegate& operator=(
      const NeutronNSSCryptoModuleDelegate&) = delete;
 ...
 private:
  friend class base::RefCountedThreadSafe<NeutronNSSCryptoModuleDelegate>;
  ~NeutronNSSCryptoModuleDelegate() override;
