...
NeutronPDFDocumentHelperClient::NeutronPDFDocumentHelperClient() = default;
NeutronPDFDocumentHelperClient::~NeutronPDFDocumentHelperClient() = default;

void NeutronPDFDocumentHelperClient::UpdateContentRestrictions(
  ...
  auto* api_wc = neutron::api::WebContents::From(wc);
  if (api_wc) {
    api_wc->PDFReadyToPrint();
  }
}

void NeutronPDFDocumentHelperClient::SetPluginCanSave(
    content::RenderFrameHost* render_frame_host,
    bool can_save) {
...
void NeutronPDFDocumentHelperClient::OnSearchifyStarted(
    content::RenderFrameHost* render_frame_host) {}
#endif
