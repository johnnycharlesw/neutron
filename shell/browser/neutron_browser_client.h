...
class NeutronBluetoothDelegate;
class NeutronBrowserMainParts;
...
class NeutronBrowserClient : public content::ContentBrowserClient,
                              private content::RenderProcessHostObserver {
 public:
  static NeutronBrowserClient* Get();
  static void SetApplicationLocale(const std::string& locale);

  NeutronBrowserClient();
  ~NeutronBrowserClient() override;

  // disable copy
  NeutronBrowserClient(const NeutronBrowserClient&) = delete;
  NeutronBrowserClient& operator=(const NeutronBrowserClient&) = delete;
 ...
 private:
  ...
  std::unique_ptr<NeutronSerialDelegate> serial_delegate_;
  std::unique_ptr<NeutronBluetoothDelegate> bluetooth_delegate_;
  std::unique_ptr<NeutronUsbDelegate> usb_delegate_;
  std::unique_ptr<NeutronHidDelegate> hid_delegate_;
  std::unique_ptr<NeutronWebAuthenticationDelegate>
