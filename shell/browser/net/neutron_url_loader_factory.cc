...
template <>
struct Converter<neutron::ProtocolType> {
  static bool FromV8(v8::Isolate* isolate,
                     v8::Local<v8::Value> val,
                     neutron::ProtocolType* out) {
    using Val = neutron::ProtocolType;
...
NeutronURLLoaderFactory::RedirectedRequest::RedirectedRequest(
  ...
  loader_receiver_.set_disconnect_handler(
      base::BindOnce(&NeutronURLLoaderFactory::RedirectedRequest::DeleteThis,
  ...
  target_factory_remote_.set_disconnect_handler(base::BindOnce(
      &NeutronURLLoaderFactory::RedirectedRequest::OnTargetFactoryError,
      base::Unretained(this)));
}

NeutronURLLoaderFactory::RedirectedRequest::~RedirectedRequest() = default;

void NeutronURLLoaderFactory::RedirectedRequest::FollowRedirect(
    const std::vector<std::string>& removed_headers,
    const net::HttpRequestHeaders& modified_headers,
    const net::HttpRequestHeaders& modified_cors_exempt_headers,
...
void NeutronURLLoaderFactory::RedirectedRequest::OnTargetFactoryError() {
...
void NeutronURLLoaderFactory::RedirectedRequest::DeleteThis() {
...
NeutronURLLoaderFactory::Create(ProtocolType type,
                                 const ProtocolHandler& handler) {
  mojo::PendingRemote<network::mojom::URLLoaderFactory> pending_remote;

  // The NeutronURLLoaderFactory will delete itself when there are no more
  // receivers - see the SelfDeletingURLLoaderFactory::OnDisconnect method.
  new NeutronURLLoaderFactory(type, handler,
                               pending_remote.InitWithNewPipeAndPassReceiver());

  return pending_remote;
}

NeutronURLLoaderFactory::NeutronURLLoaderFactory(
    ProtocolType type,
    const ProtocolHandler& handler,
...
NeutronURLLoaderFactory::~NeutronURLLoaderFactory() = default;

void NeutronURLLoaderFactory::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
  ...
  handler_.Run(
      request,
      base::BindOnce(&NeutronURLLoaderFactory::StartLoading, std::move(loader),
                     request_id, options, request, std::move(client),
                     traffic_annotation, std::move(target_factory), type_));
}

// static
void NeutronURLLoaderFactory::OnComplete(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
    int32_t request_id,
...
// static
void NeutronURLLoaderFactory::StartLoading(
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
...
// static
void NeutronURLLoaderFactory::StartLoadingBuffer(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
...
// static
void NeutronURLLoaderFactory::StartLoadingFile(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    network::mojom::URLResponseHeadPtr head,
...
// static
void NeutronURLLoaderFactory::StartLoadingHttp(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    const network::ResourceRequest& original_request,
    const net::MutableNetworkTrafficAnnotationTag& traffic_annotation,
  ...
  auto* browser_context =
      dict.Get("session", &session) && !session.IsEmpty()
          ...
          : NeutronBrowserContext::GetDefaultBrowserContext();
...
// static
void NeutronURLLoaderFactory::StartLoadingStream(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
    mojo::PendingReceiver<network::mojom::URLLoader> loader,
    network::mojom::URLResponseHeadPtr head,
    const gin_helper::Dictionary& dict) {
...
// static
void NeutronURLLoaderFactory::SendContents(
    mojo::PendingRemote<network::mojom::URLLoaderClient> client,
    network::mojom::URLResponseHeadPtr head,
    std::string data) {
  mojo::Remote<network::mojom::URLLoaderClient> client_remote(
