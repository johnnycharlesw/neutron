...
class NeutronURLLoaderFactory : public network::SelfDeletingURLLoaderFactory {
 public:
  ...
  // disable copy
  NeutronURLLoaderFactory(const NeutronURLLoaderFactory&) = delete;
  NeutronURLLoaderFactory& operator=(const NeutronURLLoaderFactory&) = delete;

 private:
  NeutronURLLoaderFactory(
      ProtocolType type,
      const ProtocolHandler& handler,
      mojo::PendingReceiver<network::mojom::URLLoaderFactory> factory_receiver);
  ~NeutronURLLoaderFactory() override;
