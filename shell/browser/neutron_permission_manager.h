...
class NeutronPermissionManager : public content::PermissionControllerDelegate {
 public:
  NeutronPermissionManager();
  ~NeutronPermissionManager() override;

  // disable copy
  NeutronPermissionManager(const NeutronPermissionManager&) = delete;
  NeutronPermissionManager& operator=(const NeutronPermissionManager&) =
      delete;
