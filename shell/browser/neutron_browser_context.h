...
class NeutronDownloadManagerDelegate;
class NeutronPermissionManager;
...
class NeutronBrowserContext : public content::BrowserContext {
 public:
  // disable copy
  NeutronBrowserContext(const NeutronBrowserContext&) = delete;
  NeutronBrowserContext& operator=(const NeutronBrowserContext&) = delete;

  [[nodiscard]] static std::vector<NeutronBrowserContext*> BrowserContexts();

  [[nodiscard]] static bool IsValidContext(const void* context);

  // Get or create the default BrowserContext.
  static NeutronBrowserContext* GetDefaultBrowserContext(
      base::Value::Dict options = {});

  // Get or create the BrowserContext according to its |partition| and
  // |in_memory|. The |options| will be passed to constructor when there is no
  // existing BrowserContext.
  static NeutronBrowserContext* From(const std::string& partition,
                                      bool in_memory,
                                      base::Value::Dict options = {});
  ...
  // existing BrowserContext.
  static NeutronBrowserContext* FromPath(const base::FilePath& path,
                                          base::Value::Dict options = {});
  ...
  ~NeutronBrowserContext() override;
 ...
 private:
  ...
  NeutronBrowserContext(const PartitionOrPath partition_location,
                         bool in_memory,
                         base::Value::Dict options);

  NeutronBrowserContext(base::FilePath partition, base::Value::Dict options);
  ...
  std::unique_ptr<NeutronDownloadManagerDelegate> download_manager_delegate_;
  std::unique_ptr<WebViewManager> guest_manager_;
  std::unique_ptr<NeutronPermissionManager> permission_manager_;
  ...
  std::unique_ptr<NeutronPreconnectManagerDelegate>
