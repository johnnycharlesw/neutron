...
NeutronDownloadManagerDelegate::NeutronDownloadManagerDelegate(
...
void NeutronDownloadManagerDelegate::GetItemSavePath(
...
void NeutronDownloadManagerDelegate::GetItemSaveDialogOptions(
    download::DownloadItem* item,
...
void NeutronDownloadManagerDelegate::OnDownloadPathGenerated(
  ...
  if (path.empty()) {
    ...
    auto dialog_callback = base::BindOnce(
        &NeutronDownloadManagerDelegate::OnDownloadSaveDialogDone,
...
void NeutronDownloadManagerDelegate::OnDownloadSaveDialogDone(
    const std::string& download_guid,
...
void NeutronDownloadManagerDelegate::Shutdown() {
  weak_ptr_factory_.InvalidateWeakPtrs();
  download_manager_ = nullptr;
}

bool NeutronDownloadManagerDelegate::DetermineDownloadTarget(
  ...
  base::ThreadPool::PostTaskAndReplyWithResult(
      ...
      base::BindOnce(&NeutronDownloadManagerDelegate::OnDownloadPathGenerated,
                     weak_ptr_factory_.GetWeakPtr(), download->GetGuid(),
                     std::move(*callback)));
  return true;
}

bool NeutronDownloadManagerDelegate::ShouldOpenDownload(
    download::DownloadItem* download,
    content::DownloadOpenDelayedCallback callback) {
  return true;
}

void NeutronDownloadManagerDelegate::GetNextId(
