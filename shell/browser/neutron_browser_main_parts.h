...
class NeutronExtensionsClient;
class NeutronExtensionsBrowserClient;
#endif
...
class NeutronBrowserMainParts : public content::BrowserMainParts {
 public:
  NeutronBrowserMainParts();
  ~NeutronBrowserMainParts() override;

  // disable copy
  NeutronBrowserMainParts(const NeutronBrowserMainParts&) = delete;
  NeutronBrowserMainParts& operator=(const NeutronBrowserMainParts&) = delete;

  static NeutronBrowserMainParts* Get();
 ...
 private:
...
#if BUILDFLAG(ENABLE_ELECTRON_EXTENSIONS)
  std::unique_ptr<NeutronExtensionsClient> extensions_client_;
  std::unique_ptr<NeutronExtensionsBrowserClient> extensions_browser_client_;
#endif
  ...
  static NeutronBrowserMainParts* self_;
};
