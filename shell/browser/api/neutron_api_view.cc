...
struct Converter<views::ChildLayout> {
  static bool FromV8(v8::Isolate* isolate,
    ...
    if (!gin::ConvertFromV8(isolate, val, &dict))
      return false;
    gin_helper::Handle<neutron::api::View> view;
...
void View::AddChildViewAt(gin_helper::Handle<View> child,
  ...
  // and https://github.com/neutron/neutron/pull/14911
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_view, Initialize)
