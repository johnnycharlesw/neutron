...
class Menu : public gin::Wrappable<Menu>,
             ...
             public NeutronMenuModel::Delegate,
             private NeutronMenuModel::Observer {
 public:
  ...
  NeutronMenuModel* model() const { return model_.get(); }
 ...
 protected:
  ...
  bool GetSharingItemForCommandId(
      int command_id,
      NeutronMenuModel::SharingItem* item) const override;
  ...
  std::unique_ptr<NeutronMenuModel> model_;
...
template <>
struct Converter<neutron::NeutronMenuModel*> {
  static bool FromV8(v8::Isolate* isolate,
                     v8::Local<v8::Value> val,
                     neutron::NeutronMenuModel** out) {
    ...
    neutron::api::Menu* menu;
    if (!Converter<neutron::api::Menu*>::FromV8(isolate, val, &menu))
      return false;
    *out = menu->model();
    return true;
  }
