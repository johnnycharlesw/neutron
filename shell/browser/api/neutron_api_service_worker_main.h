...
// StoragePartition in which they're registered. In Neutron, this is always
...
class ServiceWorkerMain final
 ...
 private:
  ...
  mojom::NeutronRenderer* GetRendererApi();
  ...
  mojo::AssociatedRemote<mojom::NeutronRenderer> remote_;
