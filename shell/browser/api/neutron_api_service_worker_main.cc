...
#include "shell/browser/api/neutron_api_service_worker_main.h"
...
mojom::NeutronRenderer* ServiceWorkerMain::GetRendererApi() {
  if (!remote_.is_bound()) {
...
using neutron::api::ServiceWorkerMain;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_service_worker_main,
                                  Initialize)
