...
#include "shell/browser/api/neutron_api_power_monitor.h"
...
using neutron::api::PowerMonitor;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_power_monitor, Initialize)
