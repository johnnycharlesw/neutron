...
bool IsEncryptionAvailable() {
  ...
  // on Linux.
  // Refs: https://github.com/neutron/neutron/issues/32206.
...
v8::Local<v8::Value> EncryptString(v8::Isolate* isolate,
  ...
  return neutron::Buffer::Copy(isolate, ciphertext).ToLocalChecked();
}
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_safe_storage, Initialize)
