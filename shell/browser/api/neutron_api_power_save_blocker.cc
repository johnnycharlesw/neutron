...
#include "shell/browser/api/neutron_api_power_save_blocker.h"
...
void Initialize(v8::Local<v8::Object> exports,
  ...
  dict.Set("powerSaveBlocker",
           neutron::api::PowerSaveBlocker::Create(isolate));
}

}  // namespace

NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_power_save_blocker,
                                  Initialize)
