...
template <>
struct Converter<neutron::api::DesktopCapturer::Source> {
  static v8::Local<v8::Value> ToV8(
      v8::Isolate* isolate,
      const neutron::api::DesktopCapturer::Source& source) {
    ...
    dict.Set("thumbnail",
             neutron::api::NativeImage::Create(
...
#if BUILDFLAG(IS_WIN)
    // Gather the same unique screen IDs used by the neutron.screen API in
...
void Initialize(v8::Local<v8::Object> exports,
  ...
  dict.SetMethod("createDesktopCapturer",
                 &neutron::api::DesktopCapturer::Create);
  dict.SetMethod(
      "isDisplayMediaSystemPickerAvailable",
      &neutron::api::DesktopCapturer::IsDisplayMediaSystemPickerAvailable);
}

}  // namespace

NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_desktop_capturer, Initialize)
