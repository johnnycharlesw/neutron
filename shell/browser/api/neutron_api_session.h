...
class Session final : public gin::Wrappable<Session>,
 ...
 public:
  ...
  // |browser_context| is an NeutronBrowserContext before downcasting.
  static Session* FromOrCreate(v8::Isolate* isolate,
  ...
  Session(v8::Isolate* isolate, NeutronBrowserContext* browser_context);
  ~Session() override;
 ...
 private:
  ...
  const raw_ref<NeutronBrowserContext> browser_context_;
