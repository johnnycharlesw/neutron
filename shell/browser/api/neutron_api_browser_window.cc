...
#include "shell/browser/api/neutron_api_web_contents_view.h"
...
BrowserWindow::BrowserWindow(gin::Arguments* args,
  ...
  // See https://github.com/neutron/neutron/pull/41256.
...
using neutron::api::BrowserWindow;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_window, Initialize)
