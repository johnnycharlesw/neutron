...
#include "shell/browser/api/neutron_api_tray.h"
...
template <>
struct Converter<neutron::TrayIcon::IconType> {
  static bool FromV8(v8::Isolate* isolate,
                     v8::Local<v8::Value> val,
                     neutron::TrayIcon::IconType* out) {
    using Val = neutron::TrayIcon::IconType;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_tray, Initialize)
