...
template <>
struct Converter<neutron::TaskbarHost::ThumbarButton> {
  static bool FromV8(v8::Isolate* isolate,
                     v8::Local<v8::Value> val,
                     neutron::TaskbarHost::ThumbarButton* out) {
...
v8::Local<v8::Value> ToBuffer(v8::Isolate* isolate,
  ...
  auto buffer = neutron::Buffer::Copy(isolate, val);
  if (buffer.IsEmpty())
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_base_window, Initialize)
