...
#include "shell/browser/api/neutron_api_in_app_purchase.h"
...
using neutron::api::InAppPurchase;
...
NODE_LINKED_BINDING_CONTEXT_AWARE(neutron_browser_in_app_purchase, Initialize)
