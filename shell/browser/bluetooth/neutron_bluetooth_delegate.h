...
// Web Bluetooth Scanning API. This is the Neutron-specific implementation of
// the BluetoothDelegate.
class NeutronBluetoothDelegate : public content::BluetoothDelegate {
 public:
  NeutronBluetoothDelegate();
  ~NeutronBluetoothDelegate() override;

  // Move-only class.
  NeutronBluetoothDelegate(const NeutronBluetoothDelegate&) = delete;
  NeutronBluetoothDelegate& operator=(const NeutronBluetoothDelegate&) =
      delete;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronBluetoothDelegate> weak_factory_{this};
};
