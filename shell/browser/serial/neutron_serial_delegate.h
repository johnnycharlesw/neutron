...
class NeutronSerialDelegate : public content::SerialDelegate,
                               private SerialChooserContext::PortObserver {
 public:
  NeutronSerialDelegate();
  ~NeutronSerialDelegate() override;

  // disable copy
  NeutronSerialDelegate(const NeutronSerialDelegate&) = delete;
  NeutronSerialDelegate& operator=(const NeutronSerialDelegate&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronSerialDelegate> weak_factory_{this};
};
...
template <>
struct ScopedObservationTraits<neutron::SerialChooserContext,
                               neutron::SerialChooserContext::PortObserver> {
  static void AddObserver(
      neutron::SerialChooserContext* source,
      neutron::SerialChooserContext::PortObserver* observer) {
