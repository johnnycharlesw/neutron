...
void PermissionRequestResponseCallbackWrapper(
    NeutronPermissionManager::StatusCallback callback,
...
class NeutronPermissionManager::PendingRequest {
 public:
...
NeutronPermissionManager::NeutronPermissionManager() = default;

NeutronPermissionManager::~NeutronPermissionManager() = default;

void NeutronPermissionManager::SetPermissionRequestHandler(
...
void NeutronPermissionManager::SetPermissionCheckHandler(
    const CheckHandler& handler) {
  check_handler_ = handler;
}

void NeutronPermissionManager::SetDevicePermissionHandler(
    const DeviceCheckHandler& handler) {
  device_permission_handler_ = handler;
}

void NeutronPermissionManager::SetProtectedUSBHandler(
    const ProtectedUSBHandler& handler) {
  protected_usb_handler_ = handler;
}

void NeutronPermissionManager::SetBluetoothPairingHandler(
    const BluetoothPairingHandler& handler) {
  bluetooth_pairing_handler_ = handler;
}

// static
bool NeutronPermissionManager::IsGeolocationDisabledViaCommandLine() {
...
bool NeutronPermissionManager::HasPermissionRequestHandler() const {
  return !request_handler_.is_null();
}

bool NeutronPermissionManager::HasPermissionCheckHandler() const {
  return !check_handler_.is_null();
}

void NeutronPermissionManager::RequestPermissionWithDetails(
...
void NeutronPermissionManager::RequestPermissions(
    content::RenderFrameHost* render_frame_host,
...
void NeutronPermissionManager::RequestPermissionsWithDetails(
    content::RenderFrameHost* render_frame_host,
    const content::PermissionRequestDescription& request_description,
    base::Value::Dict details,
  ...
  for (size_t i = 0; i < request_description.permissions.size(); ++i) {
    ...
    const auto callback =
        base::BindRepeating(&NeutronPermissionManager::OnPermissionResponse,
                            base::Unretained(this), request_id, i);
    request_handler_.Run(web_contents, permission, callback, dict_value);
  }
}

void NeutronPermissionManager::OnPermissionResponse(
    int request_id,
    int permission_id,
...
void NeutronPermissionManager::ResetPermission(
    blink::PermissionType permission,
    const GURL& requesting_origin,
    const GURL& embedding_origin) {}

void NeutronPermissionManager::RequestPermissionsFromCurrentDocument(
    content::RenderFrameHost* render_frame_host,
    const content::PermissionRequestDescription& request_description,
...
blink::mojom::PermissionStatus NeutronPermissionManager::GetPermissionStatus(
...
content::PermissionResult
NeutronPermissionManager::GetPermissionResultForOriginWithoutContext(
    const blink::mojom::PermissionDescriptorPtr& permission_descriptor,
...
void NeutronPermissionManager::CheckBluetoothDevicePair(
...
bool NeutronPermissionManager::CheckPermissionWithDetails(
    blink::PermissionType permission,
    content::RenderFrameHost* render_frame_host,
    const GURL& requesting_origin,
...
bool NeutronPermissionManager::CheckDevicePermission(
    blink::PermissionType permission,
    const url::Origin& origin,
    const base::Value& device,
    NeutronBrowserContext* browser_context) const {
  if (permission == blink::PermissionType::GEOLOCATION &&
      IsGeolocationDisabledViaCommandLine())
    return false;
...
void NeutronPermissionManager::GrantDevicePermission(
    blink::PermissionType permission,
    const url::Origin& origin,
    const base::Value& device,
    NeutronBrowserContext* browser_context) const {
...
void NeutronPermissionManager::RevokeDevicePermission(
    blink::PermissionType permission,
    const url::Origin& origin,
    const base::Value& device,
    NeutronBrowserContext* browser_context) const {
...
NeutronPermissionManager::USBProtectedClasses
NeutronPermissionManager::CheckProtectedUSBClasses(
...
content::PermissionResult
NeutronPermissionManager::GetPermissionResultForCurrentDocument(
    const blink::mojom::PermissionDescriptorPtr& permission_descriptor,
    content::RenderFrameHost* render_frame_host,
...
content::PermissionResult
NeutronPermissionManager::GetPermissionResultForWorker(
    const blink::mojom::PermissionDescriptorPtr& permission_descriptor,
...
content::PermissionResult
NeutronPermissionManager::GetPermissionResultForEmbeddedRequester(
    const blink::mojom::PermissionDescriptorPtr& permission_descriptor,
    content::RenderFrameHost* render_frame_host,
    const url::Origin& requesting_origin) {
  if (render_frame_host->IsNestedWithinFencedFrame())
