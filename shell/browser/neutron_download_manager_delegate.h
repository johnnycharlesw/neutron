...
class NeutronDownloadManagerDelegate
 ...
 public:
  explicit NeutronDownloadManagerDelegate(content::DownloadManager* manager);
  ~NeutronDownloadManagerDelegate() override;

  // disable copy
  NeutronDownloadManagerDelegate(const NeutronDownloadManagerDelegate&) =
      delete;
  NeutronDownloadManagerDelegate& operator=(
      const NeutronDownloadManagerDelegate&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<NeutronDownloadManagerDelegate> weak_ptr_factory_{this};
};
