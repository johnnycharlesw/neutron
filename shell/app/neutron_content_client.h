...
class NeutronContentClient : public content::ContentClient {
 public:
  NeutronContentClient();
  ~NeutronContentClient() override;

  // disable copy
  NeutronContentClient(const NeutronContentClient&) = delete;
  NeutronContentClient& operator=(const NeutronContentClient&) = delete;
