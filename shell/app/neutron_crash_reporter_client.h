...
class NeutronCrashReporterClient : public crash_reporter::CrashReporterClient {
 public:
  static void Create();

  // disable copy
  NeutronCrashReporterClient(const NeutronCrashReporterClient&) = delete;
  NeutronCrashReporterClient& operator=(const NeutronCrashReporterClient&) =
      delete;

  static NeutronCrashReporterClient* Get();
 ...
 private:
  friend class base::NoDestructor<NeutronCrashReporterClient>;
  ...
  NeutronCrashReporterClient();
  ~NeutronCrashReporterClient() override;
};
