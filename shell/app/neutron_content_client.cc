...
NeutronContentClient::NeutronContentClient() = default;

NeutronContentClient::~NeutronContentClient() = default;

std::u16string NeutronContentClient::GetLocalizedString(int message_id) {
  return l10n_util::GetStringUTF16(message_id);
}

std::string_view NeutronContentClient::GetDataResource(
    int resource_id,
...
gfx::Image& NeutronContentClient::GetNativeImageNamed(int resource_id) {
  return ui::ResourceBundle::GetSharedInstance().GetNativeImageNamed(
      resource_id);
}

base::RefCountedMemory* NeutronContentClient::GetDataResourceBytes(
    int resource_id) {
  return ui::ResourceBundle::GetSharedInstance().LoadDataResourceBytes(
      resource_id);
}

void NeutronContentClient::AddAdditionalSchemes(Schemes* schemes) {
...
void NeutronContentClient::AddPlugins(
...
void NeutronContentClient::AddContentDecryptionModules(
