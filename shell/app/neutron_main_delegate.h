...
class NeutronMainDelegate : public content::ContentMainDelegate {
 public:
  static const char* const kNonWildcardDomainNonPortSchemes[];
  static const size_t kNonWildcardDomainNonPortSchemesSize;
  NeutronMainDelegate();
  ~NeutronMainDelegate() override;

  // disable copy
  NeutronMainDelegate(const NeutronMainDelegate&) = delete;
  NeutronMainDelegate& operator=(const NeutronMainDelegate&) = delete;
